...
public class AttributeOverviewView extends CustomComponent {
	...
	public void setShowSubjectAttribute(boolean chosen) {
		optionGroupParent.setValue(chosen ? SUBJECT_ATTRIBUTES : VISIT_ATTRIBUTES);
	}
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		verticalLayout_2.addComponent(visitListView);
		verticalLayout_2.setExpandRatio(visitListView, 1.0f);
