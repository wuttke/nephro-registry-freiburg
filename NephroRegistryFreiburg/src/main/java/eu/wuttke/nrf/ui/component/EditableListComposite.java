...
implements ListView<E> {
	...
	public void provideSearchSupport(boolean supportsSearch, TextChangeListener listener) {
		textFieldSearch.setVisible(supportsSearch);
		textFieldSearch.setImmediate(supportsSearch);
		if (listener != null)
			textFieldSearch.addTextChangeListener(listener);
	}
	...
	private VerticalLayout buildMainLayout() {
		...
		mainLayout.addComponent(textFieldSearch);
