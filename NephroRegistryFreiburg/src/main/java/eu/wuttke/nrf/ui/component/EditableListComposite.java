...
import eu.wuttke.nrf.domain.misc.Refreshable;

public class EditableListComposite 
...
implements Refreshable {
	...
	protected void changeEntity(Object item) {
		
	}

	protected void deleteEntity(Object item) {
