...
implements EditorView<Diagnosis> {
	...
	@AutoGenerated
	@PropertyId("codingSystem")
	private ComboBox comboBoxCodingSystem;
	@AutoGenerated
	...
	public DiagnosisEditorView() {
		...
		for (DiagnosisCodingSystem cs : DiagnosisCodingSystem.values())
			comboBoxCodingSystem.addItem(cs);
	}
	...
	private FormLayout buildFormLayout() {
		...
		// comboBoxCodingSystem
		comboBoxCodingSystem = new ComboBox();
		comboBoxCodingSystem.setCaption("Coding System");
		comboBoxCodingSystem.setImmediate(false);
		comboBoxCodingSystem.setWidth("-1px");
		comboBoxCodingSystem.setHeight("-1px");
		formLayout.addComponent(comboBoxCodingSystem);
