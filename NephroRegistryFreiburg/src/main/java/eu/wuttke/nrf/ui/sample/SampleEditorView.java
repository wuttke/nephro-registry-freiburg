...
implements EditorView<Sample> {
	...
	private TextField tfConc;
	@AutoGenerated
	@PropertyId("opticalDensity")
	...
	private FormLayout buildFormLayout() {
		...
		tfSampleId.setNullSettingAllowed(false);
		...
		// tfOd
		tfOd = new TextField();
		tfOd.setCaption("Optical Density");
		tfOd.setImmediate(false);
		tfOd.setWidth("-1px");
		tfOd.setHeight("-1px");
		tfOd.setNullSettingAllowed(true);
		tfOd.setNullRepresentation("");
		formLayout.addComponent(tfOd);
		
		// tfConc
		tfConc = new TextField();
		tfConc.setCaption("Concentration");
		tfConc.setImmediate(false);
		tfConc.setWidth("-1px");
		tfConc.setHeight("-1px");
		tfConc.setNullSettingAllowed(true);
		tfConc.setNullRepresentation("");
		formLayout.addComponent(tfConc);
