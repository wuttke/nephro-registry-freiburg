...
public class SearchListComposite<E> extends CustomComponent implements SearchView<E> {
	...
	@Override
	public void addSearchFieldBlurListener(final BlurListener listener) {
		tfSearch.addBlurListener(listener);
		
		// trigger Blur on Enter key
		tfSearch.addShortcutListener(new ShortcutListener("", ShortcutAction.KeyCode.ENTER, null) {
