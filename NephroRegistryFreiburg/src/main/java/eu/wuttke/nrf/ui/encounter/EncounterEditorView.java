...
implements EditorView<Encounter> {
	...
	private TextField tfEncounterDateTime;
	@AutoGenerated
	@PropertyId("label")
	...
	public EncounterEditorView() {
		...
		tfEncounterDateTime.setConverter(new StringToDateTimeConverter());
	...
	private FormLayout buildFormLayout() {
		...
		// tfEncounterDateTime
		tfEncounterDateTime = new TextField();
		tfEncounterDateTime.setCaption("Date Time");
		tfEncounterDateTime.setImmediate(true);
		tfEncounterDateTime.setWidth("100.0%");
		tfEncounterDateTime.setHeight("-1px");
		tfEncounterDateTime.setRequired(true);
		formLayout.addComponent(tfEncounterDateTime);
